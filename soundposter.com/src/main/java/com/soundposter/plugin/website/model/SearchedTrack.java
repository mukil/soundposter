...
public class SearchedTrack {
    ...
    public String title = "", streaming_url = "", username = "", source_url = "", description = "",
            publisher_url = "", artist_name = "", album_name = "", license_info = "", artwork_url = "";
    public int trackId = 0, ordinal = 0;
    public boolean streamable = false;

    public SearchedTrack(int trackId, int ordinal, String title, String streaming_url, String publisher_url, String source_url,
            String description, String license, String album_name, String artist_name, String artwork_url) {
    ...
    public SearchedTrack(String title, String url, String userpage, String source_url, boolean streamable,
            String description, int trackId, int ordinal, String license) {
        this.title = title;
        this.streaming_url = url;
        this.publisher_url = userpage;
        this.streamable = streamable;
