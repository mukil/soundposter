...
$TARGET_EMAIL = array(EMAIL_NAME."@soundposter\.com$");

            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","rma@mikromedia.de");

            /* Help: http://www.tectite.com/fmdoc/site_domain.php */
$SITE_DOMAIN = "http://soundposter.com";           // your website domain name
...
function LoadBuiltinLanguage()
{
    ...
    $aMessages[MSG_LOG_OK] = 'OK';
        ...
        // Parameters: none
    $aMessages[MSG_THANKS_PAGE] = 'Thanks!  We\'ve received your subscription '.
                                  'and, if we have news to tell, you\'ll be the first to know about it.';
