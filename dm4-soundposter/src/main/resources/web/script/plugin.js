dm4c.add_plugin("de.deepamehta.soundposter", function() {

    dm4c.load_script("/de.deepamehta.soundposter/script/js/jquery.jplayer.min.js")
    //
    ...
    dm4c.add_listener('init', function (e) {
        console.log("Soundposter-Plugin.initializing(1.0b) ... ")
    ...
    function show_soundposter_player() {
      ...
      var container = '<div id="jp_container" class="player">' + 
        '<ul>' +
          '<li><a class="jp-play" href="#"><img src="/de.deepamehta.soundposter/images/playb.png" height="24" title="Play"/></a></li>' +
          '<li><a class="jp-pause" href="#"><img src="/de.deepamehta.soundposter/images/pauseb.png" height="24" title="Pause"/></a></li>' +
          /** '<li><a class="jp-stop" href="#">Stop</a></li>' + **/
          '<li><a class="jp-prev" href="#"><img src="/de.deepamehta.soundposter/images/prevb.png" height="24" title="Previous"/></a></li>' +
          '<li><a class="jp-next" href="#"><img src="/de.deepamehta.soundposter/images/nextb.png" height="24" title="Next"/></a></li>' +
      ...
      my_jPlayer.jPlayer({
        ...
        swfPath: "/de.deepamehta.soundposter/script/js",
