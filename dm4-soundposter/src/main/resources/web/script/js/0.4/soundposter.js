var sp = new function() {
    ...
    this.load = function(soundposter) {
        ...
        var soundposter_name = soundposter.value
        var soundposter_tags = soundposter.composite["com.soundposter.tag"]
        var soundposter_license = soundposter.composite["com.soundposter.license_info"]
        var soundoster_description = soundposter.composite["dm4.topicmaps.description"]
        var rendering_options = soundposter.composite["com.soundposter.display_options"]
        var last_modified = soundposter.composite["com.soundposter.last_modified"]
        ...
        for (var i=0; i <= rendering_options.length; i++) {
            ...
            if (rendering_options[i] != undefined) {
                if (rendering_options[i].uri === "com.soundposter.display_sound_labels") {
                    // sp.render_tracks()
                ...
                console.log(rendering_options[i].uri)
            }
        }
